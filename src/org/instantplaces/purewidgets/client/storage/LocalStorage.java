...
public class LocalStorage {
	...
	public  String getString(String item) {
		...
		String value = org.instantplaces.purewidgets.client.storage.json.LocalStorage.getString(name);
		return value;
	}


public void setString(String item, String value) {
	org.instantplaces.purewidgets.client.storage.json.LocalStorage.setString(this.appName+"-"+item, value);
}
	...
	public int [] loadIntList(String name) {
		...
		String codedList = org.instantplaces.purewidgets.client.storage.json.LocalStorage.getString(name);
	...
	public void saveIntList(String name, int [] list) {
		...
		org.instantplaces.purewidgets.client.storage.json.LocalStorage.setString(name,  sb.toString());
	}
	...
	public void saveList(String name, ArrayList<String> values) {
		name = this.appName+"-"+name;
		org.instantplaces.purewidgets.client.storage.json.LocalStorage.setString(name, encode(values));
	}
}
